 ...
 */
final class Version20260910100646 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'ajout de la contrainte de cle etrangere pins vers users et de la colonne is_verified dans users';
    }
